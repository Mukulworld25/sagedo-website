...
import { FileText, ChevronRight, Check, ArrowLeft, Download, Share2, Image as ImageIcon, Wand2 } from 'lucide-react';
...
import { AppRoute, AssignmentParams } from '../mobile-types';
...
export const Tools: React.FC<ToolsProps> = ({ onNavigate }) => {
  const tools = [
    { id: 'assignment', name: 'Assignment Writer', desc: 'Essays, reports, case studies', icon: '📝', route: AppRoute.TOOL_ASSIGNMENT },
    { id: 'image-edit', name: 'Magic Image Editor', desc: 'Edit with text prompts', icon: '🎨', route: AppRoute.TOOL_IMAGE_EDITOR },
    { id: 'resume', name: 'Resume Builder', desc: 'Professional templates', icon: '📄', route: null },
    { id: 'content', name: 'Content Creator', desc: 'Blogs, Social Media', icon: '✍️', route: null },
    { id: 'math', name: 'Math Solver', desc: 'Step-by-step solutions', icon: '➗', route: null },
    { id: 'study', name: 'Study Guide', desc: 'Exam prep material', icon: '📚', route: null },
  ];

  return (
    <div className="p-4 pb-24 space-y-4 animate-fade-in">
      <div className="bg-gradient-to-r from-brand-secondary to-brand-primary p-6 rounded-2xl text-white shadow-lg mb-6">
        <h2 className="text-xl font-bold mb-2">Create New</h2>
        <p className="opacity-90 text-sm">Select a tool to start generating content powered by Gemini 2.5.</p>
      </div>
  ...
  return (
     <div className="p-4 space-y-6 pb-24 animate-fade-in">
       <Card>
         ...
         <p className="text-sm text-gray-500 mb-4">Upload a photo and describe how to change it (e.g., "Add a retro filter", "Make it snowy"). Powered by Gemini Flash Image.</p>
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                    ...
                    <select 
                        className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-brand-surface border border-gray-200 dark:border-brand-border-dark outline-none"
            ...
            <div className="space-y-1.5">
                 ...
                 <textarea 
                    className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-brand-surface border border-gray-200 dark:border-brand-border-dark focus:ring-2 focus:ring-brand-primary/50 outline-none h-24 resize-none"
