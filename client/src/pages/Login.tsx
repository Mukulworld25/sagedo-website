        ...
        try {
            ...
            if (response.ok) {
                ...
                toast({
                    ...
                    description: isRegister ? "You've received FREE AI Templates + 1 Free Service Credit!" : 'Successfully logged in'
                });
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-background">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">
                        {isRegister
                            ? 'Get FREE AI Templates + 1 Free Service Credit on signup!'
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Button variant="outline" className="h-12 bg-muted/30 hover:bg-muted/50 border-border/50" onClick={() => window.location.href = '/api/auth/google'}>
                    ...
                    <Button variant="outline" className="h-12 bg-muted/30 hover:bg-muted/50 border-border/50" onClick={() => window.location.href = '/api/auth/github'}>
