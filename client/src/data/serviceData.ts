...
export const allServices: ServiceDetail[] = [
  ...
  },
  {
    ...
    fullDescription: "Your entire digital business — in 30 days. Includes CRM, SEO, and WhatsApp bot.",
    price: 35000,
    priceRange: "₹35,000",
    ...
    standardFeatures: ["Everything in Starter", "SEO Setup + 4 Blog Posts", "WhatsApp Sales Bot", "CRM + Lead Automation"],
    premiumFeatures: [],
    maintenance: "Available",
