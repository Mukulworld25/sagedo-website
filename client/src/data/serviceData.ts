...
export const allServices: ServiceDetail[] = [
  {
    ...
    name: "Starter Launch",
    category: "Business",
    description: "Everything a new business needs to exist online.",
    fullDescription: "Stop being invisible. Start being found. We build everything from logo to website to Google Business profile so you can start selling immediately.",
    price: 15000,
    priceRange: "₹15,000",
    imageUrl: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1000&auto=format&fit=crop",
    isGoldenEligible: false,
    deliveryTime: "10-14 days",
    whyBuy: "Foundational digital presence for any serious entity.",
    standardFeatures: ["Logo + Brand Identity", "5-Page Website", "Google Business Profile", "GST Registration", "Business Email"],
    premiumFeatures: [],
  ...
  },
  {
    ...
    name: "Full Launch",
    category: "Business",
    description: "Complete execution. You sell, we build everything.",
    fullDescription: "Your entire digital business — in 30 days. Includes CRM, SEO, WhatsApp bot, and social media starting content.",
    price: 35000,
    priceRange: "₹35,000",
    imageUrl: "https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=1000&auto=format&fit=crop",
    isGoldenEligible: false,
    deliveryTime: "30 days",
    whyBuy: "Scale immediately without worrying about the tech stack.",
    standardFeatures: ["Everything in Starter", "SEO Setup + 4 Blog Posts", "WhatsApp Sales Bot", "CRM + Lead Automation", "30 Days Social Content"],
    premiumFeatures: [],
    maintenance: "Available",
  ...
  },
  {
    ...
    name: "VIP Launch",
    category: "Business",
    description: "Enterprise infrastructure. No compromises.",
    fullDescription: "Built for businesses that refuse second place. Enterprise Web + Native App, God Mode Dashboard, and dedicated growth engineer.",
    price: 95000,
    priceRange: "₹95,000",
    ...
    whyBuy: "Built for businesses that refuse second place.",
    standardFeatures: ["Enterprise Web + Native App", "Admin 'God Mode' Dashboard", "Dedicated Growth Engineer", "Legal & IP Contracts Included"],
    premiumFeatures: [],
    maintenance: "Available",
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1596524430615-b46475ddff6e?q=80&w=1000&auto=format&fit=crop',
    isGoldenEligible: false,
    deliveryTime: '10–14 days',
  ...
  },
  {
    ...
    category: 'Scale Business',
    description: 'One video becomes 25 pieces of content. Automatically.',
    fullDescription: 'Turn one long-form video or podcast into 15 edited vertical video clips (reels/shorts), 5 text newsletters, and 5 social media threads. AI-driven scene cutting with human editing checks.',
    price: 12999,
    priceRange: '₹12,999/month',
    imageUrl: 'https://images.unsplash.com/photo-1611162616475-46b635cb6868?q=80&w=1000&auto=format&fit=crop',
    isGoldenEligible: false,
    deliveryTime: '5–7 days per batch',
    whyBuy: 'Content is king. But creating it daily is a full-time job. We automate it.',
    badge: 'B-Tier',
    standardFeatures: ['15 vertical video clips', '5 text newsletters', '5 social media threads', 'Caption overlays', 'Dynamic subtitles'],
    premiumFeatures: ['Custom brand templates', 'A/B thumbnail testing', 'Multi-platform formatting', 'Engagement analytics', 'Content calendar'],
    maintenance: 'Monthly content batch processing',
    maintenancePrice: '₹12,999/mo (included)',
    howWeDoIt: 'AI-driven scene cutting → Caption template overlay → Dynamic subtitle styling → Human editing checks → Multi-platform export',
    howWeStart: 'Share a link to your raw long-form podcast or video.',
    whatItTakes: 'Long-form raw media assets, brand logo, fonts, and tone guidelines.',
    whatIsIncluded: ['15 edited vertical video clips (reels/shorts)', '5 text newsletters', '5 social media threads', 'Caption & subtitle overlays', 'Platform-specific formatting', 'Human quality review'],
    costDetails: '₹12,999/month (recurring)'
  },
  {
  ...
  },
  {
    ...
    price: 7999,
    priceRange: '₹7,999 – ₹12,999',
    imageUrl: 'https://images.unsplash.com/photo-1553484771-371a605b060b?q=80&w=1000&auto=format&fit=crop',
    isGoldenEligible: false,
    deliveryTime: '3–5 days',
  ...
  },
  {
    ...
    price: 14999,
    priceRange: '₹14,999 – ₹24,999/month',
    imageUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f2?q=80&w=1000&auto=format&fit=crop',
    isGoldenEligible: false,
