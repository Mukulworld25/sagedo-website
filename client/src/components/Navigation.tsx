      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center">
            <span className="text-2xl font-black bg-gradient-to-r from-primary to-destructive bg-clip-text text-transparent">
              SAGEDO AI
            </span>
          </Link>
              ...
              <Link key={link.href} href={link.href}>
                <button
                  ...
                  className={`block w-full text-left px-3 py-2 rounded-md text-sm font-medium hover-elevate ${
                    location === link.href ? "text-foreground bg-accent" : "text-muted-foreground"
                  }`}
                >
                  {link.label}
                </button>
